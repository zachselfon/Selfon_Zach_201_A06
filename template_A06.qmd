...
```{r}
# recursive function returns the sum of the digits in a number
sum_digits <- function(x) {
  # Base case for if n is less than 10
  if (n < 10) {
    return(n)
  } else {
    # Recursive case and sums the last digit and the sum of the remaining digits
